...
# MIT License originally from https://github.com/vitally/BMP280/blob/master/LICENSE
...
class BMP280:
        ...
        def pressure(self):
            ...
            self.paPressure = (self.p + (self.var1 + self.var2 + (self.dig_P7)) / 16.0) / 100
            return self.paPressure
